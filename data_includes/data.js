...
[["target-1-too-04", 1], "AcceptabilityJudgment", {s: "The cook is a dancer and the waiter, who is a boxer, dances too, I have been"}],
[["target-1-nil-04", 1], "AcceptabilityJudgment", {s: "The cook is a swimmer and the waiter, who is a boxer, dances often, I have"}],
[["target-1-too-08", 1], "AcceptabilityJudgment", {s: "The cook is a dancer and the waiter, who is a great boxer from southern"}],
[["target-1-nil-08", 1], "AcceptabilityJudgment", {s: "The cook is a swimmer and the waiter, who is a great boxer from southern"}],
[["target-1-too-12", 1], "AcceptabilityJudgment", {s: "The cook is a dancer and the waiter, who is a great lightweight boxer from"}],
[["target-1-nil-12", 1], "AcceptabilityJudgment", {s: "The cook is a swimmer and the waiter, who is a great lightweight boxer from"}],

[["target-2-too-00", 2], "AcceptabilityJudgment", {s: "The librarian is a painter and the history teacher paints too, according to"}],
[["target-2-nil-00", 2], "AcceptabilityJudgment", {s: "The librarian is a reader and the history teacher paints frequently, according to my"}],
[["target-2-too-04", 2], "AcceptabilityJudgment", {s: "The librarian is a painter and the history teacher, who presides over an"}],
[["target-2-nil-04", 2], "AcceptabilityJudgment", {s: "The librarian is a reader and the history teacher, who presides over an"}],
[["target-2-too-08", 2], "AcceptabilityJudgment", {s: "The librarian is a painter and the history teacher, who presides over the"}],
[["target-2-nil-08", 2], "AcceptabilityJudgment", {s: "The librarian is a reader and the history teacher, who presides over the"}],
[["target-2-too-12", 2], "AcceptabilityJudgment", {s: "The librarian is a painter and the history teacher, who presides over the"}],
[["target-2-nil-12", 2], "AcceptabilityJudgment", {s: "The librarian is a reader and the history teacher, who presides over the"}],

[["target-3-too-00", 3], "AcceptabilityJudgment", {s: "The bakery has shut down and the cafe is closed too, so the streets are"}],
[["target-3-nil-00", 3], "AcceptabilityJudgment", {s: "The bakery is dull and the cafe is closed down, so the streets are empty."}],
[["target-3-too-04", 3], "AcceptabilityJudgment", {s: "The bakery has shut down and the cafe, which was built nearby, is closed too,"}],
[["target-3-nil-04", 3], "AcceptabilityJudgment", {s: "The bakery is dull and the cafe, which was built nearby, is closed down, so the"}],
[["target-3-too-08", 3], "AcceptabilityJudgment", {s: "The bakery has shut down and the cafe, which was built near the beautiful old"}],
[["target-3-nil-08", 3], "AcceptabilityJudgment", {s: "The bakery is dull and the cafe, which was built near the beautiful old"}],
[["target-3-too-12", 3], "AcceptabilityJudgment", {s: "The bakery has shut down and the cafe, which was built near the beautiful old"}],
[["target-3-nil-12", 3], "AcceptabilityJudgment", {s: "The bakery is dull and the cafe, which was built near the beautiful old"}],
...
[["target-4-too-04", 4], "AcceptabilityJudgment", {s: "The cat has eaten and the dog, which was nervous today, had his food too, so"}],
[["target-4-nil-04", 4], "AcceptabilityJudgment", {s: "The cat has slept and the dog, which was nervous today, had his food earlier, so"}],
[["target-4-too-08", 4], "AcceptabilityJudgment", {s: "The cat has eaten and the dog, which was nervous today because of the"}],
[["target-4-nil-08", 4], "AcceptabilityJudgment", {s: "The cat has slept and the dog, which was nervous today because of the"}],
[["target-4-too-12", 4], "AcceptabilityJudgment", {s: "The cat has eaten and the dog, which was very nervous today because of the"}],
[["target-4-nil-12", 4], "AcceptabilityJudgment", {s: "The cat has slept and the dog, which was very nervous today because of the"}],
...
[["target-12-too-00", 12], "AcceptabilityJudgment", {s: "My father is a passionate card player and my mom likes playing cards too, but"}],
[["target-12-nil-00", 12], "AcceptabilityJudgment", {s: "My father is a checkers player and my mom likes playing cards sometimes, but I have never"}],
[["target-12-too-04", 12], "AcceptabilityJudgment", {s: "My father is a card player and my mom, who is all about work, likes playing"}],
[["target-12-nil-04", 12], "AcceptabilityJudgment", {s: "My father is a checkers player and my mom, who is all about work, likes"}],
[["target-12-too-08", 12], "AcceptabilityJudgment", {s: "My father is a card player and my mom, who is all about work and does not have"}],
[["target-12-nil-08", 12], "AcceptabilityJudgment", {s: "My father is a checkers player and my mom, who is all about work and does not"}],
[["target-12-too-12", 12], "AcceptabilityJudgment", {s: "My father is a card player and my mom, who is all about work and usually"}],
[["target-12-nil-12", 12], "AcceptabilityJudgment", {s: "My father is a checkers player and my mom, who is all about work and usually"}],
...
[["target-21-too-00", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was introduced in January and the anti-corruption"}],
[["target-21-nil-00", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was cancelled in January and the anti-corruption bill"}],
[["target-21-too-04", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was introduced in January and the anti-corruption"}],
[["target-21-nil-04", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was canceled in January and the anti-corruption bill,"}],
[["target-21-too-08", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was introduced in January and the anti-corruption"}],
[["target-21-nil-08", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was canceled in January and the anti-corruption bill,"}],
[["target-21-too-12", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was introduced in January and the anti-corruption"}],
[["target-21-nil-12", 21], "AcceptabilityJudgment", {s: "The anti-conspiracy law was canceled in January and the anti-corruption"}],

[["target-22-too-00", 22], "AcceptabilityJudgment", {s: "Facebook received money, and Google was subsidised too, my mother pointed out."}],
[["target-22-nil-00", 22], "AcceptabilityJudgment", {s: "Facebook used Harvard's network, and Google was subsidised hugely, my mother pointed"}],
[["target-22-too-04", 22], "AcceptabilityJudgment", {s: "Facebook received money, and Google, a huge internet brand, was subsidised too,"}],
[["target-22-nil-04", 22], "AcceptabilityJudgment", {s: "Facebook used Harvard's network, and Google, a huge internet brand, was"}],
[["target-22-too-08", 22], "AcceptabilityJudgment", {s: "Facebook received money, and Google, a huge internet brand which changed our"}],
[["target-22-nil-08", 22], "AcceptabilityJudgment", {s: "Facebook used Harvard's network, and Google, a huge internet brand which"}],
[["target-22-too-12", 22], "AcceptabilityJudgment", {s: "Facebook received money, and Google, a huge internet brand which changed our"}],
[["target-22-nil-12", 22], "AcceptabilityJudgment", {s: "Facebook used Harvard's network, and Google, a huge internet brand which"}],
...
[["target-24-too-04", 24], "AcceptabilityJudgment", {s: "The kids were apologetic and Suzy, emotionally attached to them, felt sorry"}],
[["target-24-nil-04", 24], "AcceptabilityJudgment", {s: "The kids were indifferent and Suzy, emotionally attached to them, felt sorry instantly,"}],
[["target-24-too-08", 24], "AcceptabilityJudgment", {s: "The kids were apologetic and Suzy, who must have grown emotionally attached"}],
[["target-24-nil-08", 24], "AcceptabilityJudgment", {s: "The kids were indifferent and Suzy, who must have grown emotionally attached"}],
[["target-24-too-12", 24], "AcceptabilityJudgment", {s: "The kids were apologetic and Suzy, who must have grown emotionally attached"}],
[["target-24-nil-12", 24], "AcceptabilityJudgment", {s: "The kids were indifferent and Suzy, who must have grown emotionally attached"}],

[["target-25-too-00", 25], "AcceptabilityJudgment", {s: "The robots were functioning and the humans were working too, people from the management"}],
...
[["target-25-too-04", 25], "AcceptabilityJudgment", {s: "The robots were functioning and the humans, brought for the job, were"}],
[["target-25-nil-04", 25], "AcceptabilityJudgment", {s: "The robots were idle and the humans, brought for the job, were working swiftly, the"}],
[["target-25-too-08", 25], "AcceptabilityJudgment", {s: "The robots were functioning and the humans, brought to the planet"}],
[["target-25-nil-08", 25], "AcceptabilityJudgment", {s: "The robots were idle and the humans, brought to the planet specifically for"}],
[["target-25-too-12", 25], "AcceptabilityJudgment", {s: "The robots were functioning and the humans, brought to the planet"}],
[["target-25-nil-12", 25], "AcceptabilityJudgment", {s: "The robots were idle and the humans, brought to the planet specifically for"}],
...
[["target-29-too-04", 29], "AcceptabilityJudgment", {s: "Senator Pye was found dead and some local people, who the suspect"}],
[["target-29-nil-04", 29], "AcceptabilityJudgment", {s: "Senator Pye was found missing and some local people, who the suspect"}],
[["target-29-too-08", 29], "AcceptabilityJudgment", {s: "Senator Pye was found dead and some local people, who the suspect contacted"}],
[["target-29-nil-08", 29], "AcceptabilityJudgment", {s: "Senator Pye was found missing and some local people, who the suspect"}],
[["target-29-too-12", 29], "AcceptabilityJudgment", {s: "Senator Pye was found dead and some local people, who the suspect contacted"}],
[["target-29-nil-12", 29], "AcceptabilityJudgment", {s: "Senator Pye was found missing and some local people, who the suspect"}],

[["target-30-too-00", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals suffered a loss on Sunday and the rest of the AFC North"}],
[["target-30-nil-00", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals gained a win on Sunday and the rest of the AFC North"}],
[["target-30-too-04", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals suffered a loss on Sunday and the rest of the AFC North,"}],
[["target-30-nil-04", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals gained a win on Sunday and the rest of the AFC North,"}],
[["target-30-too-08", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals suffered a loss on Sunday and the rest of the AFC North,"}],
[["target-30-nil-08", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals gained a win on Sunday and the rest of the AFC North,"}],
[["target-30-too-12", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals suffered a loss on Sunday and the rest of the AFC North,"}],
[["target-30-nil-12", 30], "AcceptabilityJudgment", {s: "The Cincinnati Bengals gained a win on Sunday and the rest of the AFC North,"}],
...
[["target-31-too-04", 31], "AcceptabilityJudgment", {s: "The husky halted and the man, seemingly scared by the noise, stopped too,"}],
[["target-31-nil-04", 31], "AcceptabilityJudgment", {s: "The husky jumped and the man, seemingly scared by the noise, stopped suddenly, and"}],
[["target-31-too-08", 31], "AcceptabilityJudgment", {s: "The husky halted and the man, seemingly scared by the noise appearing out of"}],
[["target-31-nil-08", 31], "AcceptabilityJudgment", {s: "The husky stopped and the man, seemingly scared by the noise appearing out of"}],
[["target-31-too-12", 31], "AcceptabilityJudgment", {s: "The husky halted and the man, seemingly scared by the noise appearing out of"}],
[["target-31-nil-12", 31], "AcceptabilityJudgment", {s: "The husky jumped and the man, seemingly scared by the noise appearing out of"}],
